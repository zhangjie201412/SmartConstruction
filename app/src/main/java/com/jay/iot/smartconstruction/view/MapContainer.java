package com.jay.iot.smartconstruction.view;
...
import com.jay.iot.smartconstruction.R;
...
public class MapContainer extends ViewGroup implements MapView.OnMapStateChangedListner {
    ...
    private void initMarkers() {
        ...
        for (int i = 0, size = mMarkers.size(); i < size; i++) {
            ...
            final LabeledImageView markerView = new LabeledImageView(mContext);
            ...
            markerView.setText("123");
            markerView.setLabelLocation(7);
